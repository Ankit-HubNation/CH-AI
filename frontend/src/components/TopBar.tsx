      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex max-w-[min(22rem,calc(100vw-2rem))] items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-indigo-500/50 hover:bg-white/10 transition-all duration-200 text-sm font-medium"
          >
            <div className="w-2 h-2 rounded-full bg-cyan-400 animate-ping" />
            <span className="min-w-0 truncate text-slate-200 font-semibold">{activeModelObj.name}</span>
            <span className="shrink-0 text-[10px] px-1.5 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">
              {activeModelObj.tag}
            </span>
          ...
          {modelDropdownOpen && (
            <>
              ...
              />
              <div className="fixed top-[4.25rem] left-3 md:left-80 z-40 w-[min(20rem,calc(100vw-1.5rem))] max-h-[min(28rem,calc(100vh-5rem))] overflow-y-auto rounded-2xl bg-slate-950/95 backdrop-blur-2xl border border-white/15 p-2 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-200">
